/**
 * A collection of used svgs
 * @type {{star: string, iconUsersSVG: string, iconJobsSVG: string, sortingArrowUp: string, clear: string, back: string, blacklist: string, menu: string, error: string, ArrowRight: string, ArrowDown: string, cloud: string, amivWheel: string, search: string, studydoc: string, ArrowLeft: string, iconEventSVG: string, checked: string, sortingArrowDown: string, department: string, email: string, group: string}}
 */
export const icons = {
  search:
